...
namespace KMHPatch.Features.Quests.Dto
{
    ...
    public class QuestSnapshot
    {
        ...
        [JsonProperty("lifetime_quests_posted")]
        public long LifetimeQuestsPosted { get; set; } = 0;

        [JsonProperty("lifetime_quests_completed")]
        public long LifetimeQuestsCompleted { get; set; } = 0;

        [JsonProperty("lifetime_bounty_silver_paid")]
    ...
    public class QuestEntry
    {
        ...
        // Delivery target - DeliverItem kind only
